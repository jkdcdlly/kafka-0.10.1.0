...
public final class Cluster {
    ...
    // TopicPartition：里就是一个 topic 名字 和一个 partition 号，
    // PartitionInfo: 除了有topic 名字和partition 号外，还有 leader 所在 broker， replicas 所在 broker，inSyncReplicas 所在 broker
